...
<header class="page-header columns sixteen">
    <h2 class="page-title quick-note search-title"><?php
        printf( __( 'Resultado da busca por: %s', 'sampression' ), '<span>' . get_search_query() . '</span>' ); ?>
    </h2>
</header>
  ...
  <?php  else: ?>
    ...
    <article id="post-0" class="no-results not-found">
        <header class="entry-header">
            <h2 class="entry-title"><?php _e( 'Nenhum resultado para: ', 'sampression' ); echo '&quot;' . get_search_query() . '&quot;'; ?></h2>
        </header><!-- .entry-header -->
